...
const MOCK_SCREENS: ScreenDef[] = [
  ...
  { screen_key:'packages-composition',       display_name:'Package Composition',          route_path:'/packages/composition',        phase:'mvp',     status:'active',      role_access:['preparer','reviewer'],                                     feature_cluster:'FC-3',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'packages-flags',             display_name:'Package Flags',                route_path:'/packages/flags',              phase:'mvp',     status:'active',      role_access:['preparer','reviewer'],                                     feature_cluster:'FC-3',  dependency_screen_keys:['packages-composition'], is_system_screen:false, override_count:0 },
  ...
  { screen_key:'approvals-review',           display_name:'Reviewer Dialog',              route_path:'/approvals/review',            phase:'mvp',     status:'active',      role_access:['reviewer'],                                               feature_cluster:'FC-4',  dependency_screen_keys:['approvals-queue'],   is_system_screen:false, override_count:0 },
  ...
  { screen_key:'export-upload-task',         display_name:'Upload Task',                  route_path:'/export/upload-task',          phase:'mvp',     status:'active',      role_access:['accountant','controller'],                                 feature_cluster:'FC-7',  dependency_screen_keys:['export-preflight'],  is_system_screen:false, override_count:0 },
  ...
  // Phase 2 samples
  { screen_key:'records-correction',         display_name:'Record Correction',            route_path:'/records/correction',          phase:'phase_2', status:'development', role_access:['controller','lease_admin'],                                feature_cluster:'FC-5',  dependency_screen_keys:['records-detail'],    is_system_screen:false, override_count:0 },
  { screen_key:'records-snapshot-viewer',    display_name:'Snapshot Viewer',              route_path:'/records/snapshot',            phase:'phase_2', status:'development', role_access:['auditor','controller'],                                    feature_cluster:'FC-5',  dependency_screen_keys:['records-detail'],    is_system_screen:false, override_count:0 },
