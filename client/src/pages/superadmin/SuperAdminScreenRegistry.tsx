...
const MOCK_SCREENS: ScreenDef[] = [
  ...
  { screen_key:'pipeline-review-grouping',   display_name:'Create Document Set',            route_path:'/pipeline/create-document-set',             phase:'mvp',     status:'active',      role_access:['preparer'],                                               feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-validation'],is_system_screen:false, override_count:0 },
  { screen_key:'pipeline-submit-confirm',    display_name:'Submit Confirmation (V3 Deprecated)',  route_path:'/pipeline/confirm',  phase:'mvp',  status:'deprecated',  role_access:['preparer'],  feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-review-grouping'], is_system_screen:false, override_count:0 },  // V3 Change 4: BATCH_SUBMITTED fires from /pipeline/create-document-set; this screen is no longer reachable
