...
const MOCK_SCREENS: ScreenDef[] = [
  { screen_key:'pipeline-dashboard',         display_name:'Pipeline Dashboard',           route_path:'/pipeline/dashboard',          phase:'mvp',     status:'active',      role_access:['document_submitter','preparer','reviewer','system_admin'],  feature_cluster:'FC-1',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'pipeline-upload',            display_name:'Upload & Validate (Retired)',  route_path:'/pipeline/dashboard',          phase:'phase_2', status:'deprecated',     role_access:['document_submitter','preparer'],                           feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-dashboard'], is_system_screen:false, override_count:0 },
  ...
  { screen_key:'pipeline-create-document-set',   display_name:'Create Document Set',            route_path:'/pipeline/create-document-set',             phase:'mvp',     status:'active',      role_access:['preparer'],                                               feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-validation'],is_system_screen:false, override_count:0 },
  { screen_key:'pipeline-submit-confirm',    display_name:'Submit Confirmation (V3 Deprecated)',  route_path:'/pipeline/confirm',  phase:'mvp',  status:'deprecated',  role_access:['preparer'],  feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-create-document-set'], is_system_screen:false, override_count:0 },  // V3 Change 4: BATCH_SUBMITTED fires from /pipeline/create-document-set; this screen is no longer reachable
  { screen_key:'extraction-queue',           display_name:'Extraction Queue',             route_path:'/extraction/queue',            phase:'mvp',     status:'active',      role_access:['preparer','reviewer','system_admin'],                       feature_cluster:'FC-2',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  ...
  { screen_key:'approvals-queue',            display_name:'Approvals Queue',              route_path:'/approvals/queue',             phase:'mvp',     status:'active',      role_access:['approver','reviewer','system_admin'],                       feature_cluster:'FC-4',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  ...
  { screen_key:'approvals-recall',            display_name:'Recall Confirmation',          route_path:'/approvals/recall',            phase:'mvp',     status:'active',      role_access:['preparer','reviewer','system_admin'],                       feature_cluster:'FC-4',  dependency_screen_keys:['approvals-queue'],   is_system_screen:false, override_count:0 },
  ...
  { screen_key:'records-dashboard',          display_name:'Records Dashboard',            route_path:'/records/dashboard',           phase:'mvp',     status:'active',      role_access:['preparer','reviewer','approver','accountant','controller','auditor','system_admin'], feature_cluster:'FC-5', dependency_screen_keys:[], is_system_screen:false, override_count:0 },
  { screen_key:'records-detail',             display_name:'Contract Record Detail',       route_path:'/records/:id',                 phase:'mvp',     status:'active',      role_access:['preparer','reviewer','approver','accountant','controller','auditor','system_admin'], feature_cluster:'FC-5', dependency_screen_keys:['records-dashboard'], is_system_screen:false, override_count:1 },
  { screen_key:'reassessment-dashboard',     display_name:'Reassessment Hub',             route_path:'/reassessment/dashboard',      phase:'mvp',     status:'active',      role_access:['reviewer','approver','controller','auditor','system_admin'], feature_cluster:'FC-6',  dependency_screen_keys:[],                                        is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-watchlist',     display_name:'Watchlist Management',         route_path:'/reassessment/watchlist',      phase:'mvp',     status:'active',      role_access:['controller','auditor','system_admin'],                      feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-dashboard'],                is_system_screen:false, override_count:1 },
  { screen_key:'reassessment-case-list',     display_name:'Case List',                    route_path:'/reassessment/cases',          phase:'mvp',     status:'active',      role_access:['reviewer','approver','controller','auditor','system_admin'], feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-dashboard'],                is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-classification',display_name:'Case Classification',          route_path:'/reassessment/cases/:id/classify', phase:'mvp', status:'active',    role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-case-list'],                is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-assessment',    display_name:'Option Exercise Assessment',   route_path:'/reassessment/cases/:id/assessment', phase:'mvp', status:'active', role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-classification'],           is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-analysis',      display_name:'Analysis & Memo',              route_path:'/reassessment/cases/:id/analysis', phase:'mvp', status:'active',   role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-assessment'],               is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-memo',          display_name:'Reassessment Memo',            route_path:'/reassessment/cases/:id/memo', phase:'mvp',   status:'active',      role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-analysis'],                 is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-package-preview',display_name:'Package Preview',             route_path:'/reassessment/cases/:id/package', phase:'mvp', status:'active',    role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-memo'],                     is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-remediation',   display_name:'Remediation Workspace',        route_path:'/reassessment/cases/:id/remediation', phase:'mvp', status:'active', role_access:['controller','system_admin'],                                feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-classification'],           is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-survey-intake', display_name:'Survey Intake',                route_path:'/reassessment/survey-intake',  phase:'mvp',     status:'active',      role_access:['preparer','system_admin'],                                  feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-dashboard'],                is_system_screen:false, override_count:0 },
  { screen_key:'reassessment-trigger',       display_name:'Trigger New Case',             route_path:'/reassessment/trigger',        phase:'mvp',     status:'active',      role_access:['reviewer','controller','system_admin'],                     feature_cluster:'FC-6',  dependency_screen_keys:['reassessment-dashboard'],                is_system_screen:false, override_count:0 },
  { screen_key:'export-template-selection',  display_name:'Export Template Selection',    route_path:'/export/templates',            phase:'mvp',     status:'active',      role_access:['accountant','controller','system_admin'],                   feature_cluster:'FC-7',  dependency_screen_keys:[],                          is_system_screen:false, override_count:0 },
  { screen_key:'export-staging',             display_name:'Export Staging',               route_path:'/export/staging',              phase:'mvp',     status:'active',      role_access:['accountant','controller','system_admin'],                   feature_cluster:'FC-7',  dependency_screen_keys:['export-template-selection'], is_system_screen:false, override_count:0 },
  { screen_key:'export-preflight',           display_name:'Pre-Flight Validation',        route_path:'/export/preflight',            phase:'mvp',     status:'active',      role_access:['accountant','controller','system_admin'],                   feature_cluster:'FC-7',  dependency_screen_keys:['export-staging'],            is_system_screen:false, override_count:0 },
  ...
  { screen_key:'admin-users',                display_name:'User Management',              route_path:'/admin/users',                 phase:'mvp',     status:'active',      role_access:['system_admin'],                                             feature_cluster:'FC-8',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'admin-schema',               display_name:'Schema Management',            route_path:'/admin/schema',                phase:'mvp',     status:'active',      role_access:['system_admin'],                                             feature_cluster:'FC-8',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'admin-templates',            display_name:'Template Management',          route_path:'/admin/templates',             phase:'mvp',     status:'active',      role_access:['system_admin'],                                             feature_cluster:'FC-8',  dependency_screen_keys:['admin-schema'],      is_system_screen:false, override_count:0 },
  { screen_key:'admin-thresholds',           display_name:'Threshold Configuration',      route_path:'/admin/thresholds',            phase:'mvp',     status:'active',      role_access:['system_admin','auditor'],                                   feature_cluster:'FC-8',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'admin-audit-log',            display_name:'Audit Log Viewer',             route_path:'/admin/audit',                 phase:'mvp',     status:'active',      role_access:['system_admin','auditor'],                                   feature_cluster:'FC-8',  dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'admin-notifications',        display_name:'Notification Preferences',     route_path:'/admin/notifications',         phase:'mvp',     status:'active',      role_access:['preparer','reviewer','approver','accountant','controller','auditor','system_admin'], feature_cluster:'FC-8', dependency_screen_keys:[], is_system_screen:false, override_count:0 },
  { screen_key:'admin-automation-config',    display_name:'Automation Configuration',     route_path:'/admin/automation',            phase:'phase_2', status:'development', role_access:['system_admin'],                                             feature_cluster:'FC-8',  dependency_screen_keys:['admin-thresholds'],  is_system_screen:false, override_count:0 },
  ...
  { screen_key:'platform-onboarding',        display_name:'Tenant Onboarding Flow',       route_path:'/onboarding',                  phase:'mvp',     status:'active',      role_access:[],                                                          feature_cluster:'FC-10', dependency_screen_keys:[],                    is_system_screen:true,  override_count:0 },
  { screen_key:'superadmin-tenant-detail',   display_name:'Tenant Detail',                route_path:'/superadmin/tenants/:id',      phase:'mvp',     status:'active',      role_access:[],                                                          feature_cluster:'FC-10', dependency_screen_keys:['superadmin-tenant-list'], is_system_screen:false, override_count:0 },
  { screen_key:'superadmin-system-health',   display_name:'System Health',                route_path:'/superadmin/health',           phase:'mvp',     status:'active',      role_access:[],                                                          feature_cluster:'FC-10', dependency_screen_keys:[],                    is_system_screen:false, override_count:0 },
  { screen_key:'superadmin-subscriptions',   display_name:'Subscription Management',      route_path:'/superadmin/subscriptions',    phase:'mvp',     status:'active',      role_access:[],                                                          feature_cluster:'FC-10', dependency_screen_keys:['superadmin-tenant-list'], is_system_screen:false, override_count:0 },
  { screen_key:'superadmin-screen-registry', display_name:'Screen Registry',              route_path:'/superadmin/screen-registry',  phase:'mvp',     status:'active',      role_access:[],                                                          feature_cluster:'FC-10', dependency_screen_keys:['superadmin-tenant-list'], is_system_screen:false, override_count:0 },
  // Phase 2 samples
  { screen_key:'records-correction',         display_name:'Record Correction',            route_path:'/records/:id/correction',      phase:'phase_2', status:'development', role_access:['controller','system_admin'],                                feature_cluster:'FC-5',  dependency_screen_keys:['records-detail'],    is_system_screen:false, override_count:0 },
  ...
  { screen_key:'records-add-document',       display_name:'Add Document to Record',       route_path:'/records/:id/add-document',    phase:'mvp',     status:'active',      role_access:['preparer','system_admin'],                                  feature_cluster:'FC-5',  dependency_screen_keys:['records-detail'],    is_system_screen:false, override_count:0 },
  { screen_key:'records-deferred-tracker',   display_name:'Deferred Fields Tracker',      route_path:'/records/:id/deferred',        phase:'mvp',     status:'active',      role_access:['preparer','reviewer','system_admin'],                       feature_cluster:'FC-5',  dependency_screen_keys:['records-detail'],    is_system_screen:false, override_count:0 },
  { screen_key:'extraction-reprocessing',    display_name:'Reprocessing Modal',           route_path:'/extraction/reprocessing',     phase:'phase_2', status:'development', role_access:['preparer','system_admin'],                                  feature_cluster:'FC-2',  dependency_screen_keys:['extraction-queue'],  is_system_screen:false, override_count:0 },
  // FC-9: AI Agents and Automation
  { screen_key:'agent-checkpoint-queue',     display_name:'Checkpoint Queue',             route_path:'/approvals/checkpoints',       phase:'phase_2', status:'development', role_access:['preparer','reviewer','approver','system_admin','controller'], feature_cluster:'FC-9',  dependency_screen_keys:['approvals-queue'],   is_system_screen:false, override_count:0 },
  { screen_key:'agent-activity-monitor',     display_name:'Agent Activity Monitor',       route_path:'/agents/monitor',              phase:'phase_2', status:'development', role_access:['preparer','system_admin','controller'],                      feature_cluster:'FC-9',  dependency_screen_keys:['records-dashboard'], is_system_screen:false, override_count:0 },
];
