...
const MOCK_SCREENS: ScreenDef[] = [
  ...
  { screen_key:'pipeline-review-grouping',   display_name:'Create Document Set',            route_path:'/pipeline/review',             phase:'mvp',     status:'active',      role_access:['preparer'],                                               feature_cluster:'FC-1',  dependency_screen_keys:['pipeline-validation'],is_system_screen:false, override_count:0 },
