...
const MOCK_CASE = {
  ...
  title: 'Office Tower — 350 Fifth Ave', approver: 'Michael Torres',
  memo_ref: 'MEMO-2026-0088-R1', submitted_by: 'Sarah Chen', submitted_at: '2026-05-15 14:32',
};
...
const MEMO_SUMMARY = [
  ...
  { label: 'Reviewer',            value: 'Sarah Chen' },
