...
const RECENT_ACTIVITY = [
  { id:"a1",  caseId:"c1",  case_ref:"RC-2026-0014", event:"Status → pending_approval",   actor:"M. Thompson", time:"2 min ago",  path_type:"modification", status:"pending_approval"       },
  { id:"a2",  caseId:"c2",  case_ref:"RC-2026-0013", event:"Classification submitted",     actor:"J. Martinez", time:"18 min ago", path_type:"reassessment", status:"assessment_pending"     },
  { id:"a3",  caseId:"c3",  case_ref:"RC-2026-0012", event:"Tier 2 assessment completed",  actor:"A. Chen",     time:"1 hr ago",   path_type:"reassessment", status:"analysis_pending"       },
  { id:"a4",  caseId:"c4",  case_ref:"RC-2026-0011", event:"Case initiated",               actor:"S. Patel",    time:"2 hr ago",   path_type:"modification", status:"initiated"              },
  { id:"a5",  caseId:"c5",  case_ref:"RC-2026-0010", event:"Status → approved",            actor:"L. Kim",      time:"3 hr ago",   path_type:"modification", status:"classification_pending" },
  { id:"a6",  caseId:"c6",  case_ref:"RC-2026-0009", event:"Remediation flag set",         actor:"System",      time:"5 hr ago",   path_type:"modification", status:"remediation"            },
  { id:"a7",  caseId:"c7",  case_ref:"RC-2026-0008", event:"Memo draft saved",             actor:"J. Martinez", time:"Yesterday",  path_type:"reassessment", status:"memo_draft"             },
  { id:"a8",  caseId:"c8",  case_ref:"RC-2026-0007", event:"Analysis submitted",           actor:"A. Chen",     time:"Yesterday",  path_type:"modification", status:"pending_review"         },
  { id:"a9",  caseId:"c9",  case_ref:"RC-2026-0006", event:"Case closed",                  actor:"L. Kim",      time:"2 days ago", path_type:"reassessment", status:"classification_pending" },
  { id:"a10", caseId:"c10", case_ref:"RC-2026-0005", event:"No-action submitted",          actor:"M. Thompson", time:"2 days ago", path_type:"reassessment", status:"classification_pending" },
];
          ...
          <div className="col-span-2 bg-card border border-border rounded-lg overflow-hidden">
            ...
            <div className="divide-y divide-border">
              {RECENT_ACTIVITY.map(a => (
                <button key={a.id} className="flex items-center gap-4 px-5 py-3 hover:bg-muted/20 transition-colors w-full text-left" onClick={() => navigate(resolveReassessmentUrl(a.caseId, a.status))}>
                  <div
