...
const RECENT_ACTIVITY = [
  { id:"a1",  case_ref:"RC-2026-0014", event:"Status → pending_approval",   actor:"M. Thompson", time:"2 min ago",  path_type:"modification" },
  { id:"a2",  case_ref:"RC-2026-0013", event:"Classification submitted",     actor:"J. Martinez", time:"18 min ago", path_type:"reassessment" },
  { id:"a3",  case_ref:"RC-2026-0012", event:"Tier 2 assessment completed",  actor:"A. Chen",     time:"1 hr ago",   path_type:"reassessment" },
  { id:"a4",  case_ref:"RC-2026-0011", event:"Case initiated",               actor:"S. Patel",    time:"2 hr ago",   path_type:"modification" },
  { id:"a5",  case_ref:"RC-2026-0010", event:"Status → approved",            actor:"L. Kim",      time:"3 hr ago",   path_type:"modification" },
  { id:"a6",  case_ref:"RC-2026-0009", event:"Remediation flag set",         actor:"System",      time:"5 hr ago",   path_type:"modification" },
  { id:"a7",  case_ref:"RC-2026-0008", event:"Memo draft saved",             actor:"J. Martinez", time:"Yesterday",  path_type:"reassessment" },
  { id:"a8",  case_ref:"RC-2026-0007", event:"Analysis submitted",           actor:"A. Chen",     time:"Yesterday",  path_type:"modification" },
  { id:"a9",  case_ref:"RC-2026-0006", event:"Case closed",                  actor:"L. Kim",      time:"2 days ago", path_type:"reassessment" },
  { id:"a10", case_ref:"RC-2026-0005", event:"No-action submitted",          actor:"M. Thompson", time:"2 days ago", path_type:"reassessment" },
];
